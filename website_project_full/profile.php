...
@media(max-width: 500px) {
  ...
  <div class="wrapper212" style=background-color:#141414>
   ...
   <!-- START -->
      <div class="container" style=background-color:#645e50;width:350px;border-radius:12px; >
 <div id="container" >
     <p><p>
        ...
        <h2 style="text-align:center">Profile</h2>
            ...
            <a class="btn12" href="library.php">MOVIES</a>
                                    <?php
                        if ($_SESSION["plan"] == 1) {
                            ?>
            <a class="btn12_alt_blue" href="prenumenera_subscribe_checkout.php">SUBSCRIBE</a> 
                                    <?php
                        }
                            ?>
                                                    <?php
                        if ($_SESSION["plan"] == 1) {
                            ?>
                <p class="bottom-text" style=color:lightgrey>
                  Do you have a code?
                  <a href="redeem_code.php" style=color:darkblue><strong>Redeem it here</strong></a>
               </p>
                                <?php
                        }
                            ?>
     ...
     <!-- test end -->     
            ...
            <footer-bottom>  <a href="cancel_subscription.php" style=color:#999899>Cancel subscription</a> </footer-bottom> 
                                      <?php
                        }
                    ?> 
