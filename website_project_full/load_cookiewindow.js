(function (window, undefined){
	...
	AcceptCookie.prototype = {
		...
		addCookieBar: function(){
			...
			htmlBar += '<p>Vi använder kakor (cookies) för att säkerställa bästa möjliga prestanda på vår webbsida.<br />Genom att stänga detta meddelande, ger du oss samtycke till att cookies lagras. Observera att du även ger oss samtycke genom att fortsätta använda webbsidan.<a href="sekretess.php">Läs mer </a></p>';
			htmlBar += '<div class="pjAcceptCookieBarActions">';
			htmlBar += '<button type="button" class="pjAcceptCookieBarBtn">Jag samtycker</button>';
			htmlBar += '</div>';
			htmlBar += '</form>';
			htmlBar += '</div>';
