<?php
   ...
   if (isset($_POST["register"])) {
        $connection = new mysqli("localhost", "WRITE_USER", "WRITE_PASSWORD (if any)", "WRITE_DATABASE");
		...
		$dataq = $connection->query("INSERT INTO users_en (firstName, lastName, email, password, plan, regDate) VALUES ('$firstName', '$lastName', '$email', '$password', '$plan', '$date_current')");
    	...
    	if ($data === false)
		   ...
		   exit();
            ...
            $emptyvar = "You have not filled out the entire formulaire. Try again!";
            }  
...
@media(max-width: 500px) {
  ...
  <div class="wrapper212" style=background-color:#141414>
   ...
   <!-- START -->
      <div class="container" style=background-color:#645e50;width:400px;border-radius:12px; >
 <div id="container" >
     <p><p>
                  <div class="form-wrap">
            <h2 class=indent222 style=";color:white">Sign up</h2>
            <form method="post" action="sign_up.php"> 
            <div class="form-group" style=text-align:left>    
            <label for="first-name">Surname</label>  
              <br>
            <input type="text" name="firstName" placeholder="Write your surname" />
            </div>
                
            <div class="form-group" style=text-align:left>    
            <label for="last-name">Lastname&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                     <br>
            <input type="text" name="lastName" placeholder="Write your lastname"  />  
            </div>  
                
            <div class="form-group" style=text-align:left>    
            <label for="email">Email&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                   <br>    
            <input type="email" name="email" placeholder="Write your email"  />
            </div>    
                
            <div class="form-group" style=text-align:left>    
            <label for="password">Password&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>  
                <br>  
            <input type="password" name="password" placeholder="Write your password"  />
            </div>    
          
         <div class=indent222> 
              <input type="submit" name="register" value="SIGN UP" class="btn12 btn12-rounded" /> 
              </div>
               <strong>
                 <p style=color:red;text-align:center;padding:5px> <?php echo $emptyvar ?>    </p>
                 <p class="bottom-text" style=color:lightgrey;text-align:center>
                  By signing up, you are accepting our
                  <a href="policy.php" style=color:darkblue>terms and conditions</a> and
                  <a href="policy.php" style=color:darkblue>privacy policy</a>.
               </p>
                 <p style=color:lightgrey;text-align:center>Do you have an account already? <a href="sign_in.php" style=color:#007bf7>Sign in</a></p></strong>
            </form>
         </div>
      </div> 
      </div> 
