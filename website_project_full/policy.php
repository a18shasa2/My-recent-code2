...
Policy
  ...
  <div style=color:lightgrey>      
        <h3 class="indent">Cookies:</h3>

<p class="indent">COMPANY platforms use cookies to improve user-friendliness and functionality. Cookies are small text files with information stored in the browser at the request of websites. It is basically the only way for a website to be able to remember who you are between each page visited, and basically involves no risks.</p>

<p class="indent">The service at COMPANY uses cookies to store which color scheme you have chosen, to be able to remember this between each page. Nothing other than the name of the color scheme is stored, and thus no personally identifiable information.</p>

<h3 class="indent">Third party-cookies:</h3>

<p class="indent">The functionality that occurs from social media such as Facebook and Twitter may also store cookies if you are logged in to Facebook and Twitter respectively. It is something we can neither control nor do anything about, but we have a hard time believing that it can pose any risk; and this is true for most sites in the world anyway.</p>
...
<p class="indent">If you oppose the storage of cookies, you can change the settings in your browser to not accept cookies. However, it has major consequences on most websites, so you should be aware of its side effects. Then you will not be able to Log in to either our forum or most discussion forums online, the choice of color scheme on the site will be ignored and in most cases you will not be able to Log in anywhere online. However, all material on COMPANY remains available in any case.<p></p>

<h3 class="indent">Personal information:</h3>
