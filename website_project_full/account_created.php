...
@media(max-width: 500px) {
 ...
 <div id="container" >
     <p><p>
         <div class="form-wrap">
            <h2 style="text-align:center;color:white">&nbsp Account created!</h2>
            <form>
               <p style=color:lightgrey;text-align:center>
                  You have created an account!<br> 
                  You can now sign in!<br>
               </p>
              <a href="sign_in.php" style=text-align:center;color:#007bf7><strong>Sign in</strong></a> <br>
              <br>
            </form>
         </div>
      </div> 
