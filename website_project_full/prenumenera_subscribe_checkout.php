<?php
    ...
    $email_pay_check_data = $_SESSION["email"];
...
.btn12_alt_blue:hover {
	opacity: 0.9;
    background: ;
}

.btn12_alt_blue-rounded {
	border-radius: 5px;
}
...
@media(max-width: 500px) {
    ...
    margin-left: 60px;
         ...
         .form-wrap .bottom-text {
            ...
            padding:5px;
             ...
             .card { width: 300px; background-color:transparent; border-color:transparent}
  ...
  <div class="wrapper212" style=background-color:#141414>
   ...
   <!-- START -->
      <div class="container" style=background-color:#645e50;width:330px;border-radius:12px; >
 <div id="container" >
     <p><p>
        <div class="row" >
            <div class="col-md-4">
                <div class="card" style=color:lightgrey>
                    <div class="card-header text-center">
                        <h2 class="price" style=color:white><span class="currency">SEK/mon</span>69</h2>
                    </div>
                    <div class="card-body">
                        <h2 class="text-center" style=color:white>Subscription</h2>
                        <ul class="list-group">
...
<strong><p id="demo" style=color:darkred></p></strong>

<script>
function myFunction() {
  document.getElementById("demo").innerHTML = "The payment-site is loading. Please wait. ⏳";
}
</script>
...
<button
  class=btn12_alt_blue
  id="checkout-button-price_WRITEPRICEID"
  role="link"
  type="button"
  onclick="myFunction()"
>
...
<script>
(function() {
  var stripe = Stripe('WRITE_STRIPE_PK');

  var checkoutButton = document.getElementById('checkout-button-price_WRITEPRICEID');
  checkoutButton.addEventListener('click', function () {
    ...
    stripe.redirectToCheckout({
      lineItems: [{price: 'price_WRITEPRICEID', quantity: 1}],
      mode: 'subscription',
      /*
      ...
      customerEmail: '<?php echo $email_pay_check_data ?>',
    })
