...
Policy
  ...
  <div style=color:lightgrey>      
        <h3 class="indent">Angående cookies:</h3>

<p class="indent">COMPANY plattformer använder sig av cookies (kakor), för att förbättra användarvänligheten och funktionaliteten. Cookies är små textfiler med information som lagras i webbläsaren på begäran av webbsajter. Det är i stort sett det enda sättet för en webbsajt att kunna minnas vem man är mellan varje sida som besöks, och medför i grund och botten inga risker.</p>

<p class="indent">Tjänsten på COMPANY använder cookies för att lagra vilket färgschema du valt, för att kunna komma ihåg detta mellan varje sida. Inget annat än namnet på färgschemat lagras, och därmed ingen personligt identifierbar information.</p>

<h3 class="indent">Tredjepartscookies:</h3>
