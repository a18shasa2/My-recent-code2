...
@media(max-width: 500px) {
 ...
 <div id="container" >
     <p><p>
                  <div class="form-wrap">
            <h2 class=indent222 style=";color:white">Sign in</h2>
            <form method="post" action="sign_in.php"> 
            <div class="form-group" style=text-align:left>    
            <label for="email">Email</label> 
              <br>
            <input type="email" name="email" placeholder="Write email" />           </div>
                
            <div class="form-group" style=text-align:left>    
            <label for="password">Password</label>
                     <br>
            <input type="password" name="password" placeholder="Write password" />           </div>     
          
         <div class=indent222> 
              <input type="submit" value="SIGN IN" name="logIn" class="btn12 btn12-rounded" /> 
              </div>
               <strong>
                 <p style=color:red;text-align:center;padding:5px> <?php echo $ERROR ?>    </p>
                 <p class="bottom-text" style=color:lightgrey;text-align:center>
                  ...
                  <a href="policy.php" style=color:darkblue>privacy policy</a>.<br>
                  <a href="reset_password.php" style=color:#007bf9>Forgot password?</a>
               </p>
                 <p style=color:lightgrey;text-align:center>Do you not have an account? <a href="sign_up.php" style=color:#007bf7>Sign up</a></p></strong>
            </form>
         </div>
      </div> 
      </div> 
