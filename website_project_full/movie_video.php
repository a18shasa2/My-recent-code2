  ...
  <video id="player" class="video-js vjs-default-skin vjs-big-play-centered" width="700" height="420" controls controlsList="nodownload" oncontextmenu="return false;" autoplay poster="../casper.png">
    ...
    Your browser does not support php video.
      ...
      <track label="Español" kind="subtitles" srclang="es" src="../captions/english.vtt">
        ...
        <h2 id="home" >Name <a style=color:grey>|</a> Episode 1</h2> <!-- h1 settings style=font-size:40px;padding-bottom:5px; -->
          <h3 id="home" style=color:grey >TITLE</h3>
          <p style=max-width:700px;color:grey>Description of episodeDescription of episodeDescription of episodeDescription of episodeDescription of episodeDescription of episodeDescription of episodeDescription of episodeDescription of episodeDescription of episodeDescription of episodeDescription of episodeDescription of episode</p>
          <div class="box21" style=margin-top:35px>
            <a href=""><img src="../casper.png" alt="" style=max-width:100%></a>
            <a href="" style=color:white><img src="../casper.png" alt="" style=max-width:100%><strong>Casper</strong></a>
            <a href=""><img src="../Popeye.png" alt="" style=max-width:100%></a>
            <a href=""><img src="../Little lulu.jpg" alt="" style=max-width:100%></a>
            <a href=""><img src="../hoppity2.png" alt="" style=max-width:100%></a>
            <a href=""><img src="../hoppity2.png" alt="" style=max-width:100%></a>
            <a href=""><img src="../hoppity2.png" alt="" style=max-width:100%></a>
