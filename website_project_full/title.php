...
.starring span{
    ...
    <div class="movie-info" style="background-image: url('../casper.png');height:470px;">
        <div class="movie-detail">
         <a href=library.php style=color:lightgrey;font-size:14px>← Library</a> <br>
          <h1 class="movie-name" style=width:400px;><strong>Casper</strong></h1>
            <p class="genres" style=width:400px;>1945 | L | 242 min</p>
            <p class="des" style=min-width:300px;>This spooky series follows the adventures of everybody's favourite little ghost, Casper, as he attempts to make friends with everyone he meets.</p>
            <p class="starring" style=min-width:300px;><span>Starring:</span> June Foray, Norma MacMillan, Joanna Ruiz</p>
          <div class="row"  style=width:500px;>
            <a href="casper_episode1.php" class="play mr-3 pb-4 btn btn-primary text-uppercase font-weight-bold" style=width:140px;background-color:#13ae4b;margin-left:12px;font-size:0.9rem;><i class="mr-2 fas fa-play"></i>Play</a> 
                    <a href="#home" class="info btn btn-primary text-uppercase font-weight-bold" style=width:160px;background-color:white;color:black;font-size:0.9rem;><i class="mr-2 fas fa-info-circle"></i>Episodes</a>
        </div>
       </div>
    </div>
   ...
   <!-- START -->
          <h2 id="home" >Episodes</h2> <!-- h1 settings style=font-size:40px;padding-bottom:5px; -->
          <div class="box21">
