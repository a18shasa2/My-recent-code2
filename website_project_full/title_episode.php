...
video {     width:350px;      height:210px; }                
 }  
      
</style>
    
    <!-- MAIN CONTAINER -->
    <section class="main-container21" style=margin-top:13px>
      <div class="location" id="home">
   <!-- START -->
<a style=color:grey href=library.php>← Library</a> <br>

  <video id="player" class="video-js vjs-default-skin vjs-big-play-centered" width="700" height="420" controls controlsList="nodownload" oncontextmenu="return false;" autoplay poster="../casper.png">
    <source src="../video/casper_avsnitt01.mp4" type="video/mp4">
    Your browser does not support php video.
      <track label="English" kind="subtitles" srclang="en" src="../captions/english.vtt">
      <track label="Deutsch" kind="subtitles" srclang="de" src="../captions/english.vtt">
      <track label="Español" kind="subtitles" srclang="es" src="../captions/english.vtt">
  </video>
        
        <h2 id="home" >Casper <a style=color:grey>|</a> Episode 1</h2> <!-- h1 settings style=font-size:40px;padding-bottom:5px; -->
          <h3 id="home" style=color:grey >A Haunting We Will Go</h3>
          <p style=max-width:600px;color:grey>Casper the Friendly Ghost, sad that he can make no friends since everyone he meets is afraid of him, hatches an abandoned egg and becomes the emerging little duck's best friend ("Dudley") and protector. Casper continues to try and teach his new best friend the ways of being a duck, and gives Dudley a rough idea on how to swim—but with no surprise, Dudley takes to it—like a duck to water. More perils persist as Casper rescues Dudley from a Duck Hunter as a decoy plot thickens.</p>
          <div class="box21" style=margin-top:35px>
            <a href="casper_episode1.php"><img src="../casper/casper 1.png" alt="" style=max-width:100%></a>
            <a href="casper_episode2.php"><img src="../casper/casper 2.png" alt="" style=max-width:100%></a>
            <a href="casper_episode3.php"><img src="../casper/casper 3.png" alt="" style=max-width:100%></a>
            <a href="casper_episode4.php"><img src="../casper/casper 4.png" alt="" style=max-width:100%></a>
            <a href="casper_episode5.php"><img src="../casper/casper 5.png" alt="" style=max-width:100%></a>
            <a href="casper_episode6.php"><img src="../casper/casper 6.png" alt="" style=max-width:100%></a>
