<?php
	...
	if (isset($_POST["logOn"])) {
		...
		if ($data->num_rows > 0) {
            ...
            $sqll2235 = "UPDATE users_en SET email='info@otheremail.com' WHERE email='$kod1'";
            $conn->query ($sqll2235);
...
@media(max-width: 500px) {
 ...
 <div id="container" >
     <p><p>
                  <div class="form-wrap">
            <h2 style="color:white;margin-left:40px">Cancel newsletter</h2>
            <form method="post" action="cancel_newsletter.php"> 
         ...
         <div class=indent222> 
              <input type="submit" value="Cancel newsletter" name="logOn" class="btn12 btn12-rounded" /> 
              </div>
               <strong>
