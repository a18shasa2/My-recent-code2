...
@media(max-width: 500px) {
 ...
 <div id="container" >
     <p><p>
                  <div class="form-wrap">
            <h2 style="color:white;margin-left:40px">Forgot password</h2>
       <p style="text-align:center;color:lightgrey">Write your email-adress to restore your password.</p>
         ...
         <div class=indent222> 
              <input type="submit" value="Restore password" name="resetPass" class="btn12 btn12-rounded" /> 
              </div>
               <strong>
