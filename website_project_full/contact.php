           ...
           <ul class="nav text-white d-none d-lg-flex">
              ...
              <a href="about_us.php
                    " class="nav-link text-reset  d-xl-flex " onMouseOver="this.style.color='#FFF'" onMouseOut="this.style.color='#999898'" style="font-size: 1.6rem; font-weight: 700; margin-right: .9rem !important; margin-left: .9rem !important; padding-right: 0 !important; padding-left: 0 !important; padding-bottom: 0px; padding-top: 0px;">About us</a>
                      <li class="nav-item">
              <a href="contact.php
                    " class="nav-link text-reset  d-xl-flex active" onMouseOver="this.style.color='#FFF'" onMouseOut="this.style.color='#999898'" style="font-size: 1.6rem; font-weight: 700; margin-right: .9rem !important; margin-left: .9rem !important; padding-right: 0 !important; padding-left: 0 !important; padding-bottom: 0px; padding-top: 0px; border-bottom-color: #FFF; border-bottom: 0.25rem solid ;">Contact</a>
                </li>
                </li>
...
@media(max-width: 500px) {
  ...
  <div class="wrapper212" style=background-color:#141414>
    ...
    <!-- MAIN CONTAINER -->
    <section class="main-container21" style=padding:10px>
...
<!-- Beg. of newsarticle -->
        ...
        <!-- p class="indent" style="color:lightgrey">
            Send the message with the formulaire below.
</p>      
        <div  class=indent01 class=container>
            <div class="col-md-6 col-md-offset-3" align="center">
              ...
              <br>
                <input type="button" onclick="sendEmail()" value="Send message" class="btn btn-primary" style=background-color:#13ae4b>
            </div>
        </div -->

        
         <div class=indent style=background-color:#645e50;max-width:530px;border-radius:12px; >
 <div id="container" >
     <p><p>   
          <div class="form-wrap" >
        ...
        <p  style="color:lightgrey;text-align:center">
            Send the message with the formulaire below.
             </p>      
        <div   style=text-align:center;>
            <div class="col-md-6 col-md-offset-3" align="center" style=max-width:550px>
                <input id="name" placeholder="Name" class="form-control">
              <br>
                <input id="email" placeholder="Email" class="form-control">
              <br>
                <input id="subject" placeholder="Subject" class="form-control">
              <br>
                <textarea class="form-control" id="body" placeholder="Write your text" cols="30" rows="5"></textarea>
              <br>
                <input type="button" onclick="sendEmail()" value="Send message" class="btn btn-primary" style=background-color:#13ae4b>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function isNotEmpty(caller) {
            if (caller.val() == "") {
                caller.css('border', '1.5px solid red');
                return false;
            } else
                caller.css('border', '');
