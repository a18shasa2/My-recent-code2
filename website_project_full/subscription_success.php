...
@media(max-width: 500px) {
 ...
 <div id="container" >
     <p><p>
         <div class="form-wrap">
            <h2 style="text-align:center;color:white">Subscription activated!</h2>
            <form>
               <p style=color:lightgrey>
                  Congratulations! <br>You now have a subscription!  <br> <br>
                  You can now watch unlimited films! <br>
               </p>
              <a href="sign_in.php" style=color:#007bf7><strong>Sign in</strong></a> <br> <br>
            </form>
         </div>
      </div> 
      </div> 
