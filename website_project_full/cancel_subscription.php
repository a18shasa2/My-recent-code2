...
@media(max-width: 500px) {
 ...
 <div id="container" >
     <p><p>
       ...
       <h2 style="text-align:center">Cancel subscription</h2>
            <form>
               <p>
                  Do you really want to cancel the subscription?  <br> <br>
                 <a href="profile.php"><strong>No</strong></a> <br><br>
                   or
                   <br><br>
                 <a href="avbryt_prenumeneration_action.php"><strong>Yes</strong></a><br> <br>
