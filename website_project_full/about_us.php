        ...
        <img src="img/logo_1_org_white.png" alt="Logo" class="my-1 mx-2">
           ...
           <ul class="nav text-white d-none d-lg-flex">
              ...
              <a href="news.php
                  ...
                  <li class="nav-item">
              <a href="about_us.php
                    " class="nav-link text-reset  d-xl-flex active" onMouseOver="this.style.color='#FFF'" onMouseOut="this.style.color='#999898'" style="font-size: 1.6rem; font-weight: 700; margin-right: .9rem !important; margin-left: .9rem !important; padding-right: 0 !important; padding-left: 0 !important; padding-bottom: 0px; padding-top: 0px; border-bottom-color: #FFF; border-bottom: 0.25rem solid ;">About us</a>
                      <li class="nav-item">
              <a href="contact.php
...
COMPANY™ is a filmdistribution company with a focus on family entertainment for those young and young at art through a variety of film.
<br><br>
