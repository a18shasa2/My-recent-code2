...
@media(max-width: 500px) {
 ...
 <div id="container" >
     <p><p>
         ...
         <h2 style="text-align:center">Cancellation successful</h2>
            <form>
               <p>
                  The cancellation of the subscription has been successful! <br> <br> You no longer have a subscription! <br> <br>
               </p>
            </form>
         </div>
      </div> 
