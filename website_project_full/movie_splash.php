...
.starring span{
    ...
    <div class="movie-info" style="background-image: url('https://static1.colliderimages.com/wordpress/wp-content/uploads/2020/11/black-widow-poster-social-feature.jpg?q=50&fit=contain&w=750&h=375&dpr=1.5');">
        <div class="movie-detail">
         <a href=library.php style=color:lightgrey;font-size:14px>← Library</a> <br>
          <h1 class="movie-name"><strong>Black Widow</strong></h1>
            <p class="genres">1980 | L | 127 min</p>
            <p class="des">Description test test test test</p>
            <p class="starring"><span>Starring:</span> Harry Stone, Jason Alexander, Lloyd Alexander</p>
          <div class="row">
            <a href="#" class="play mr-3 pb-4 btn btn-primary text-uppercase font-weight-bold" style=width:140px;background-color:#13ae4b;margin-left:12px;><i class="mr-2 fas fa-play"></i>Play</a> 
                    <a href="#home" class="info btn btn-primary text-uppercase font-weight-bold" style=width:160px;background-color:white;color:black><i class="mr-2 fas fa-info-circle"></i>Episodes</a>
        </div>
       </div>
    </div>
   ...
   <!-- START -->
          <h2 id="home" >Library</h2> <!-- h1 settings style=font-size:40px;padding-bottom:5px; -->
          <div class="box21">
