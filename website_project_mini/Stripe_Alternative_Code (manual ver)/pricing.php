...
<body>
<div class="container">
            <h6>  &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<a href="admin.php" title="Tillbaka till huvudmenyn">← Profil </a></h6> 
    <?php
        $colNum = 1;
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header text-center">
                            <h2 class="price"><span class="currency">SEK/mån</span>'.($attributes['price']/100).'</h2>
                        </div>
                        ...
                        echo '
                            ...
                            <form action="stripeIPN.php?id='.$productID.'" method="POST">
                              <script
                                ...
                                data-description="Kortbetalning"
