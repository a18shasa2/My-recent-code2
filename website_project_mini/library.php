  ...
  <div class="dropdown-content">
    ...
    <main role="main">
      <div class="album py-5 bg-light">
        <div class="container">
            <h1>Library</h1>
            <p>See all movies och tv-series below.</p>
          <div class="row" >
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                  <a href="theo_episode.php">
                <img oncontextmenu="return false;"  class="card-img-top" src="../theo/theo_thumb.png" alt="Card image cap">
                      </a>
                <div class="card-body">
                  <a class="card-text" href="theo_episode.php" title="Theo episode" ><strong>Theo</strong></a>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                  <a href="casper_episode.php">
                <img oncontextmenu="return false;"  class="card-img-top" src="../casper.png" alt="Card image cap">
                      </a>
                <div class="card-body">
                  <a class="card-text" href="casper_episode.php" title="Casper episode" ><strong>Casper</strong></a>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                  <a href="gulliver_full_movie.php">
                <img oncontextmenu="return false;"  class="card-img-top" src="../Gulliver-thumb.png" alt="Card image cap">
                      </a>
                <div class="card-body">
                  <a class="card-text" href="gulliver_full_movie.php" title="Gulliver episode" ><strong>Gulliver´s travels</strong></a>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                  <a href="hoppity_full_movie.php">
                <img oncontextmenu="return false;"  class="card-img-top" src="../hoppity2.png" alt="Card image cap">
                      </a>
                <div class="card-body">
                  <a class="card-text" href="hoppity_full_movie.php" title="Hoppity episode" ><strong>Hoppity goes to town</strong></a>
                </div>
              </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  <a class="card-text" href="stalmannen_episode.php" title="Stålmannen episode" ><strong>Superman</strong></a>
                </div>
              </div>
            </div>
