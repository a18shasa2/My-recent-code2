...
<nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom shadow-sm">
      <a class="navbar-brand" href="en.php"><img src="../logo.png" height="48" width="140" style="margin-right:-160px;"></a>
                    ...
                    <!--Beginning of dropdown toggle bar2-->     
          <div class="dropdown">
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExample04" aria-controls="navbarsExample04" aria-expanded="false" aria-label="Toggle navigation" style="margin-left:110px;" ><img oncontextmenu="return false;"  class="mb-2" src="../lang_engelska.png" alt=""></button>
  <div class="dropdown-content">
    ...
    <a href="../no/no.php"><img class="mb-2" src="../lang_norska1.png" alt="">Norweigian</a>
      ...
      <!--End of dropdown toggle bar2--> 

        <!--Beginning of dropdown toggle bar-->     
          <div class="dropdown">
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExample04" aria-controls="navbarsExample04" aria-expanded="false" aria-label="Toggle navigation" style="margin-right:70px;"><img class="mb-2" src="../toggle_bar.png" alt=""></button>
  <div class="dropdown-content">
        <ul class="navbar-nav">
          <li class="nav-item">
...
<p></p>
       ...
       <div class="indent3">
        ...
        <li>Watch in <strong>XXXX-quality</strong>!</li>
        <li>Watch in <strong>multiple languages</strong>!</li>
        <li>Watch up to <strong>XXXXX titles</strong>!</li>
