...
<html lang="sv">
  <head>
	...
	.container { 		margin-left: 100px; 	}    	@media (max-width: 800px){    .container {        		margin-left: 0px;          }                          .indent {     margin-left: 20px;     margin-right: 0px; }                         h1 {     margin-left: -230px; }                        h6 {     margin-left: -230px; }                       video {     width:350px;      height:210px; }                }         </style>
  </head>
  <body>
...
<div class="collapse navbar-collapse" id="navbarsExample08">
  ...
  <div class="dropdown-content">
    ...
    <main role="main">
        <!-- Beginning of FREE video-->
        <h1><h1>
        <p></p>
        <h6>&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;<a href="casper_episode.php" title="Tillbaka till huvudmenyn">← List with episodes </a></h6> 
             <div class="indent">  
  <video width="700" height="420" controls controlsList="nodownload" oncontextmenu="return false;" autoplay poster="casper_play.png">
...
&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;episode 1
    ...
    <h6>&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="casper_episode02.php" title="Går till nästa episode">Next episode</a></h6> 
        <p>&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </p>
            <p class="indent" style=color:gainsboro>This is the description of the video.</p>
          ...
          <div class="row" >
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <img oncontextmenu="return false;"  oncontextmenu="return false;" class="card-img-top" src="../casper/casper%201.png" alt="Card image cap">
                            </a>
                <div class="card-body">
  ...
  <footer class="pt-4 my-md-5 pt-md-5 border-top">
    <div class="row" >
      <div class="col-12 col-md">
        <img oncontextmenu="return false;"  class="mb-2" src="../logo.png" alt="" height="60" width="195"><br>© WEBSITE 2021
      </div>
