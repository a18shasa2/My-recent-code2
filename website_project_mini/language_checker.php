...
$Destination['sv'] = 'https://website.com/se.php';
$Destination['sv-fi'] = 'https://website.com/se.php';
$Destination['sv-sv'] = 'https://website.com/se.php';
...
<div class="container">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  <a class="card-text" href="streamingtjanst.php" title="streamingtjanst" ><strong>Se streamingtjänster</strong></a>
                </div>
              </div>
            </div>
           <!--START---
        ...
        -->
              ...
              <!--End of new cards--> 
<a>&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;&nbsp;           &nbsp;</a><a class="button button--menu1234" href="registerea_nyhetsbrev.php">Registrera nyhetsbrev</a>
