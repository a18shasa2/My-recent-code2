    ...
    if (isset($_POST["register"])) {
    	...
    	if ($data === false)
		   ...
		   exit();
            ...
            $emptyvar = "You have not filled in the entire formulaire. Try again!";
            }  
         ...
         <div class="form-wrap">
            ...
            <p style=color:red> <?php echo $emptyvar ?>    </p>
               <p class="bottom-text">
                  ...
                  <a href="sekretess.php" style=color:darkblue>privacy policy</a>
               </p>
            <p>Do you have an account already? <a href="log_in.php">Log in</a></p>
            </form>
         </div>
      </div> 
      </div> 
