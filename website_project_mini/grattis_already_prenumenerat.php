...
<!-- Beg. of newsarticle -->
 ...
 <div id="container">
     <p><p>
         <div class="form-wrap">
            <h2 style="text-align:center">Has subscription!</h2>
            <form>
               <p>
                  You already have a subscription. You can now see the movies below. <br> <br>
                  <a href="library.php">See movies</a> <br>
               </p>
            </form>
         </div>
      </div> 
