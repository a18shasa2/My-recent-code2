...
<!-- Beg. of newsarticle -->
 ...
 <div id="container">
     <p><p>
         <div class="form-wrap">
            <h2 style="text-align:center">Payment succeeded!</h2>
            <form>
               <p>
                  Congratulations! The payment succeeded. <br> You now have a subscription. <br> Log in again to watch the movies. <br> <br> 
                  <a href="log_in.php">Log in again</a> <br>
               </p>
            </form>
         </div>
      </div> 
