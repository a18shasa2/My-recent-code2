<?php
  if (isset($_POST["register"])) {
		...
		$email3 = $connection->real_escape_string($_POST["email"]); 
    
	if ($email3 != "") {	
		$data = $connection->query("INSERT INTO suncap_nyhetsbrev (email) VALUES ('$email3')");

    	if ($data === false)
        	echo "Connection error!";
    	else
    	   echo "Your have been signed up - please now Log In";
           header("Location: grattis_registrerat_nyhetsbrev.php");
		   exit();
    }
    else{ 
         $emptyvar = "Du har inte skrivit in en email-adress. Försök igen!"; 
    } 
	}
...
<!-- Beg. of newsarticle -->
 <div id="container">
     <p><p>
         ...
         <div class="form-wrap" >
            <h3 style="text-align:center;">Registrera nyhetsbrev</h3>
            <form method="post" action="nyhetsbrev.php">     
            <div class="form-group" >    
            <label for="email">Email</label>    
            <input type="email" name="email" placeholder="Skriv din email"  />
            </div>      
            <div style=text-align:center>
                <input type="submit" name="register" value="Registrera" class="button button--cta button--menu" /> 
  ...
  <footer class="pt-4 my-md-5 pt-md-5 border-top">
    <div class="row" >
      <div class="col-12 col-md">
        <img oncontextmenu="return false;"  class="mb-2" src="logo.png" alt="" height="78" width="110"><br>© WEBSITE™ 2024
      </div>
