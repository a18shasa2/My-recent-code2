...
<div class="collapse navbar-collapse" id="navbarsExample08">
  ...
  <div class="dropdown-content">
    ...
    <a href="../no/no.php"><img class="mb-2" src="../lang_norska1.png" alt="">Norweigian</a>
      ...
      <!--end drop down menu--->
            <li><a class="button button--cta button--menu" href="admin.php">Inloggad</a></li>
            <li><a class="button button--menu123" href="logout.php">logga ut</a></li>
        </ul>
      </div>
...
<div class="container" class="indent">                
 <div id="container">
     <p><p>
         <div class="form-wrap">
            <h2 style="text-align:center">Redeem code</h2> 
            <form action="redeem_code.php" method="post">
               <div class="form-group">
                  <label for="password">Code</label>
                  <input type="password" name="kod" placeholder="Write code" />
               </div>
                  <div class="indent2">
                      <input type="submit" value="Redeem code" name="logOn" class="button button--cta button--menu" /> 
                </div>
