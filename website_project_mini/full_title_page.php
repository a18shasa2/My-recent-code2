<?php
    ...
    require ("logincheck_subscribe.php");
...
<div class="collapse navbar-collapse" id="navbarsExample08">
  ...
  <div class="dropdown-content">
    ...
    <main role="main">
        <!-- Beginning of PAYED video-->
        <h1><h1>
        <p></p>
        <h6>&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;<a href="library.php" title="Return to library">← Library </a></h6> 
             <div class="indent">   
  <video width="700" height="420" controls controlsList="nodownload" oncontextmenu="return false;"  autoplay>
    <source src="../video/gulliver_full_movie.mp4" type="video/mp4">
