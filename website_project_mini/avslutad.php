...
<!-- Beg. of newsarticle -->
 <div id="container">
     <p><p>
         <div class="form-wrap">
            <h2 style="text-align:center">Avslutad annons!</h2>
            <form>
               <p>
                  Annonsen har avslutats. <br> <br>
  ...
  <footer class="pt-4 my-md-5 pt-md-5 border-top">
    <div class="row" >
      <div class="col-12 col-md">
        <img oncontextmenu="return false;"  class="mb-2" src="logo.png" alt="" height="78" width="110"><br>© HorseNode™ 2024
      </div>
